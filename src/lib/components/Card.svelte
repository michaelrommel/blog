    ...
    <div class="mb-3">
      ...
      <div class="text-sm text-gruvlpurple dark:text-gruvpurple flex flex-wrap items-center">
        {#each cardData.tags as tag}
          {#if tag === 'new'}
          <span class="inline-flex mb-2 mr-2 items-center bg-gruvlemphgreen dark:bg-gruvdemphgreen rounded-full px-3 py-0 text-sm font-semibold text-gruvdfg dark:text-gruvlfg">
            {tag}
          </span>
          {:else}
          <span class="inline-flex mb-2 mr-2 items-center border border-gruvlemphpurple dark:border-gruvlemphpurple rounded-full px-3 py-0 text-sm font-semibold text-gruvlemphpurple dark:gruvpurple">
            {#if tag === 'locked'}
